...
//					glColor3f((BYTE)t->color[0] / 256.0f,(BYTE)t->color[1] / 256.0f,(BYTE)t->color[2] / 256.0f);
			...
			if (c->tileaside != -1 && c->tileaside < (int)tiles.size())
			{
...
void cWorld::importarcturus()
{
	...
	unsigned int nTextures = *((unsigned int*)(buf));
	for(i = 0; i < nTextures; i++)
	{
		pFile->read(buf, 80);
		string s = string(buf);
...
//	pFile->read(buf, 46);
	...
	water.height = 50;
	ambientlight.diffuse.x = 1;
	ambientlight.diffuse.y = 1;
	ambientlight.diffuse.z = 1;
	ambientlight.shadow.x = 1;
	ambientlight.shadow.y = 1;
	ambientlight.shadow.z = 1;
...
{
    0x00, 0x00, 0xB8, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x00, 0x40, 
    0x00, 0x00, 0x48, 0x42, 0x03, 0x00, 0x00, 0x00, 0x2D, 0x00, 0x00, 0x00, 0x2D, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80, 0x3F, 0xCD, 0xCC, 0x0C, 0x3F, 
    0x00, 0x00, 0x00, 0x3F, 0x00, 0x00, 0x00, 0x3F, 0x00, 0x00, 0x00, 0x3F, 0x09, 0x00, 0x00, 0x00, 
    0xD4, 0x84, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  
} ;
