...
//window
	...
	WINDOW_AREACOPY_TITLE,
	WINDOW_AREACOPY_MODELS,
	WINDOW_AREACOPY_TEXTURES, 
	WINDOW_AREACOPY_HEIGHT,
	WINDOW_AREACOPY_GAT,
	WINDOW_AREACOPY_LIGHTS,
	WINDOW_AREACOPY_EFFECTS,
