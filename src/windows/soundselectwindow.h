...
class cSoundSelectWindow : public cWindow
{
	...
	{
	public:
		cWindowSoundCatSelect(cWindow* parent, std::vector<cWindowTree::cTreeNode*> n, TiXmlDocument &skin) : cWindowTree(parent, n,skin)
		{
	...
	{
	public:
		cSoundList(cWindow* parent, TiXmlDocument &skin) : cWindowDataListBox<std::string>(parent,skin)
		{
		}
