...
#define ADDMENU2(m,p,t,xpos)						m = new cMenu();			m->parent = p; m->title = t; m->item = false; m->drawStyle = 1; m->y = 20; m->x = xpos; m->w = cGraphics::font->textLen(t)+10;							p->items.push_back(m); xpos += cGraphics::font->textLen(t)+10;
